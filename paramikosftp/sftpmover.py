...
def xfer_to_this_remote_dir():
    print('This fn allows you to define a full path for transfer.')
    locale = input('Where do youwant to save your file?\n')
    while (locale[0] not '/' and locale[-1] not '/'):
        locale = input('Please type a valid path for your files\n')
